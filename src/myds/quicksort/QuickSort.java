...
public class QuickSort {
	...
	private void swap(int i, int j, List<Integer> list) throws Exception {
	...
	private static int partition(int start, int end, List<Integer> list) {
		int i = start - 1;
	...
	private static void quickSortHelper(int start, int end, List<Integer> list) {
